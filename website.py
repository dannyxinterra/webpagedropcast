...
def main():
    ...
    with st.beta_container("## Objectives"):
        st.markdown('''
    ...
    with st.beta_container("## Discussions"):
    ...
    with st.beta_container("### Wettability issue"):
    ...
    with st.beta_container("### Non Ideal geometry of carbon substrate"):
        st.markdown('''
    ...
    with st.beta_container("### Diffusion-driven cross contamination"):
        st.markdown('''
    ...
    with st.beta_container("## Summary"):
        st.markdown('''
