...
manner. Supplementary video 1 shows the preliminary results, which apparently deliver inconsistent wetting behavior 
and sample size."""
...
distributed across the sample due to manufacturing imperfections, as demonstrated in Supplementary Video 1. In some 
...
wired phenomenon in some samples, e.g. in Supplementary Video 3 (carbon strip indexed from 1-6 from left to right), 
...
hypothesis was confirmed through a closer observation in Supplementary Video 4. However, lowering the height of the 
pipetting tip recklessly could result in experiment accidents, such as piercing through and even dragging the carbon 
substrate, as shown in Supplementary Video 5. The discovery of this issue is asking us to carefully tune the height 
...
figure_1_url = "https://imgur.com/ju0Zql0.png"

figure_2_url = "https://imgur.com/3WuwoNv.png"

figure_3_url = "https://imgur.com/ScCpSjK.png"

figure_4_url = "https://imgur.com/PFOTW68.png"

figure_1_cap = """Figure 1: The drop-casting method is adopted in our lab to prepare electrocatalyst samples. Despite 
its seemingly simple appearance, automating this process for high-throughput purposes can present significant 
challenges."""

figure_2_cap = """Figure 2: (a) Serious coffee ring effect will show up if a carbon paper with wet-proofing layer is 
...
figure_3_cap = """Figure 3: (a) A scheme aiming to account for the absence of a drop-casting footprint near the edge 
occasionally, as observed in Supplementary Video 3. As the height of the pipette tip is fixed across the entire 
strip, any inherent curvature in the carbon substrate can cause the droplet to be suspended on the tip without coming 
into contact with the carbon near the edge, which is evidenced in Supplementary Video 4. (b) Uneven distribution of 
...
figure_4_cap = """Figure 4: (a) A high rate of pipetting can lead to expanded drop-casting footprint, increasing the 
